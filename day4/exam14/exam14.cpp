...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		CreateWindow(L"button", L"빼기",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10, 10 + 25 +25+ 5, 100, 25, hWnd, (HMENU)4002, hInst, NULL);

		CreateWindow(L"button", L"곱하기",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10 +100+ 10, 10 + 25 + 5, 100, 25, hWnd, (HMENU)4003, hInst, NULL);

		CreateWindow(L"button", L"나누기",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10+100+10, 10 + 25 +25+ 5, 100, 25, hWnd, (HMENU)4004, hInst, NULL);
    ...
    case WM_COMMAND:
        {
			...
			case 4002:
			{
				...
				//swprintf 빠르지만 실수 출력 불가
				swprintf_s(szOutput, 256, L"뺄셈은 %d .", sub);
				MessageBox(hWnd, szOutput, L"결과", MB_OK);
			...
			case 4004:
			{
				...
				//swprintf 빠르지만 실수 출력 불가
				swprintf_s(szOutput, 256, L"나누기는 %0.2f .", div);
				MessageBox(hWnd, szOutput, L"결과", MB_OK);
