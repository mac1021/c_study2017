    ...
    case WM_PAINT:
        {
			...
			*/
			...
			SetTextColor(hdc, RGB(0, 0, 102));
			SetBkMode(hdc, TRANSPARENT);
			TextOut(hdc, 120, 220, szMsg1, wcslen(szMsg1));

			TCHAR szMsg2[] = L"E-MAIL : chlalsdn0@naver.com";
			SetTextColor(hdc, RGB(0, 0, 102));
			SetBkMode(hdc, TRANSPARENT);
			TextOut(hdc, 120, 350, szMsg2, wcslen(szMsg2));

			TCHAR szMsg3[] = L"H.P : 010-5197-1305";
			SetTextColor(hdc, RGB(0, 0, 102));
			SetBkMode(hdc, TRANSPARENT);
			TextOut(hdc, 120, 380, szMsg3, wcslen(szMsg3));
			...
			*/
			...
			myBitmap = LoadBitmap(hinst, MAKEINTRESOURCE(IDB_PNG1));
			oldBitmap = (HBITMAP)SelectObject(memDc, myBitmap);

			BitBit(hdc, 0, 0, 100, 100, memDc, 0, 0, SRCCOPY);
